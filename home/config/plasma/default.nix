{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-fded868c-96b7-4c73-80d7-2bafdd7d46d4" = [];
      ...
      "ksmserver"."Lock Session" = ["Meta+Alt+L" "Screensaver"];
      ...
      "kwin"."Window Lower" = [];
      "kwin"."Window Maximize" = ["Meta+Shift+F" "Meta+PgUp"];
      ...
      "org.kde.krunner.desktop"."_launch" = ["Alt+F2" "Meta+Space" "Search" "Alt+Space"];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."fded868c-96b7-4c73-80d7-2bafdd7d46d4" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "fded868c-96b7-4c73-80d7-2bafdd7d46d4";
      ...
      "kdeglobals"."Shortcuts"."Close" = "Ctrl+Esc; Meta+W; Ctrl+W";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{f82be858-6f7a-4efd-bf54-35aece82e24a}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{ba48229e-38ac-492b-b80e-1287d643e0e6}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{dbab4763-ca5d-4825-9be7-5fa040fdf5f7}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{64acbe85-c761-4c8b-8a49-bc0bdbf44edd}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{93546075-395d-4515-916c-80d2f187cca7}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{abd37fbb-8103-44cf-af49-ea7531c7f60b}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{55592883-7614-4c77-9655-74429fef0f7c}";
      ...
      "kwinrc"."Desktops"."Id_1" = "b2581730-64bf-4899-995d-baf0c5bb881a";
      "kwinrc"."Desktops"."Id_10" = "04b32db1-51d2-4481-9e9d-1f9dcbdf5929";
      "kwinrc"."Desktops"."Id_2" = "361b92f9-30ec-4a7e-b013-9ab15e3ee0d1";
      "kwinrc"."Desktops"."Id_3" = "3fa50426-5869-4f70-89f2-eef04ec22ae8";
      "kwinrc"."Desktops"."Id_4" = "16b80ba1-d42c-4979-984b-6b6fbe8d83a4";
      "kwinrc"."Desktops"."Id_5" = "476c3426-56d9-487e-9be5-ed62110ba192";
      "kwinrc"."Desktops"."Id_6" = "da14e743-1124-46ce-b1eb-071bfd3b7e4b";
      "kwinrc"."Desktops"."Id_7" = "5fe2e405-242d-4778-b35e-20e2e2c6b66d";
      "kwinrc"."Desktops"."Id_8" = "efd13f63-0443-4c03-86c3-f96df2022db4";
      "kwinrc"."Desktops"."Id_9" = "1c8fb569-6816-41d4-b592-d8d6476bacf6";
      "kwinrc"."Desktops"."Name_1" = 1;
      "kwinrc"."Desktops"."Name_10" = 0;
      ...
      "kwinrc"."Script-bismuth"."screenGapBottom" = 2;
      "kwinrc"."Script-bismuth"."screenGapLeft" = 2;
      "kwinrc"."Script-bismuth"."screenGapRight" = 2;
      "kwinrc"."Script-bismuth"."screenGapTop" = 2;
      "kwinrc"."Script-bismuth"."tileLayoutGap" = 2;
      ...
      "systemsettingsrc"."Open-with settings"."History" = "kit";
    };
  };
}
